...
- (void)mastePushViewController:(NSDictionary *)infoDic {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.25 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        articleVC.ArticleUrl = infoDic[@"ArticleUrl"];
        articleVC.ArticleImg = infoDic[@"ArticleImg"];
        articleVC.ID = [NSString stringWithFormat:@"%@",infoDic[@"articleID"]].integerValue;
        articleVC.ArticleTitle = infoDic[@"aps"][@"alert"][@"title"];
        articleVC.fromPush = YES;
