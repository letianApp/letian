...
@implementation GQActionSheet

static GQActionSheet *sheet = nil;
...
- (instancetype)initWithTitles:(NSArray *)titles iconNames:(NSArray *)iconNames
{
    ...
    if (self) {
        ...
        for (int i = 0; i < count ; i++) {
            GQActionSheetItem *item = [[GQActionSheetItem alloc] initWithFrame:CGRectMake(itemX, 30, 50, 110)];
            item.btnIndex = i;
...
- (void)clickAction:(GQActionSheetItem *)item
{
    if (_clickBlock) {
