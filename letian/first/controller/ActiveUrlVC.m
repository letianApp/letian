...
@interface ActiveUrlVC ()<WKUIDelegate,WKNavigationDelegate>
...
- (void)shareWebPageToPlatformType:(UMSocialPlatformType)platformType {
    ...
    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:self.activeModel.Name descr:self.activeModel.Description thumImage:self.activeModel.ActiveImg];
    shareObject.webpageUrl = self.activeModel.ActiveUrl;
